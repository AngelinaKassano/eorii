...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHost, getRequestProtocol, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, setHeader, getHeader, getQuery as getQuery$1, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/devalue/index.js';
import destr from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase, joinRelativeURL, parsePath } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/scule/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola, createConsola } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/errx/dist/index.js';
import { isVNode, toValue, version, unref } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/vue/index.mjs';
import devalue from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/Coffeefriend/Documents/GitHub/eorii/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/Coffeefriend/Documents/GitHub/eorii/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\Coffeefriend\\Documents\\GitHub\\eorii","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\Coffeefriend\\Documents\\GitHub\\eorii\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\Coffeefriend\\Documents\\GitHub\\eorii\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\Coffeefriend\\Documents\\GitHub\\eorii\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\Coffeefriend\\Documents\\GitHub\\eorii\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _OInXO8LOmq = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/Coffeefriend/Documents/GitHub/eorii";
...
const _NDrf1QlqVb = defineNitroPlugin(async (nitroApp) => {
...
const _L76uBg = defineEventHandler(async (e) => {
...
const _Nl5u3T = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _MXSyMp = defineEventHandler(async (e) => {
...
const _iWxx7n = defineEventHandler(async (e) => {
...
const _qteRuC = defineEventHandler(async (e) => {
...
const _lazy_1u3N7B = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_1u3N7B, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _L76uBg, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _Nl5u3T, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _MXSyMp, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _iWxx7n, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _qteRuC, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_1u3N7B, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/Coffeefriend/Documents/GitHub/eorii/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/Coffeefriend/Documents/GitHub/eorii/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
